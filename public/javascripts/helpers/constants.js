(function () {
  ...
  .constant('CarousingRolls', {
    "1": ["You wake up in jail, pending charges for a serious crime (Treason, sedition, grand larceny, etc.). You actually did it.",
      ...
      "You lose at the tables. Lose 1d8 × 4 gp. If you don’t have this kind of money, someone is going to be angry.",
      ...
      "You earn substantial winnings from gambling. You recuperate your lifestyle expenses for the time spent carousing and gain 1d20 × 4 gp.",
    ...
    "3": [
      "&1, &2, and &3 have all drunkenly accepted a cargo mission for the Black Sun cartel."
    ],
    "4": [
      "&1, &2, and &3 have all drunkenly placed a 500cr (1d10 * 90) bounty on &4's head, to be brought to them, roll a d6, alive if even, dead if odd."
    ]
  });
